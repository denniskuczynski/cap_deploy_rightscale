...
_cset(:aws_access_key_id) { Capistrano::CLI.password_prompt "AWS Access Key ID: " }
_cset(:aws_secret_access_key) { Capistrano::CLI.password_prompt "AWS Secret Access Key: " }
